                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="../../../style/page-login.html" class="dropdown-item ai-icon">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form  action="../../../../parsers/FilmParser.php" method="get" >
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">realisateur</label>
                                            <div class="col-sm-9">
                                        ...
                                        <label>duree:</label>
                                           <input type="number" name="duree" value="30" class="form-control" min="0" max="1000" step="1"/>
                                        </div>
                                        <div class="form-group row">
                                            <label>Genre:</label>
                                        ...
                                        <br/>
                                            <div class="custom-file">
                                                <input type="file" name="poste" class="custom-file-input">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-11 text-right ">
                                                <button type="submit" name="ajout" class="btn btn-primary btn-sm">ajouter</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

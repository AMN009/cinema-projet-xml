                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="../../../../posters/{ poster/@source }" class="rounded-lg mr-2" width="24" alt="" />
                                                        ...
                                                        <td>
                                                            <div class="dropdown ml-auto text-right">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="../../../forms/modification/film/scripts/show-script.php?film={@id}">
                                                                        <i class="las la-pen-square scale5 text-success mr-2"></i>
                                                                        Modifier le film
                                                                    </a>
                                                                    <a class="dropdown-item" href="../scripts/delete-script.php?film={@id}">

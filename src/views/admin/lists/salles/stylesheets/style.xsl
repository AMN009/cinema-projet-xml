                        ...
                        <div class="container-fluid">
                            <div class="form-head d-flex mb-3 align-items-start">
                                <div class="mr-auto d-none d-lg-block">
                                    <h2 class="text-black font-w600 mb-0">Salles</h2>
                                    <p class="mb-0">La liste de toutes les salles</p>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-primary btn-block light" onclick="location.href='../SalleForm.php';">
                                        <span class="fs-16 ml-3">Ajouter une salle</span>
                                                        ...
                                                        <td>
                                                            <div class="dropdown ml-auto text-right">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right  ">
                                                                    ...
                                                                    <a class="dropdown-item" href="../../../lists/salles/scripts/delete-script.php?salle={@id}">
